...
<main>
	...
	<Card class="mx-auto mt-8 max-w-md">
		<h1 class="mb-8 text-2xl font-semibold">Sign in</h1>
		<form method="POST" action="./login" use:enhance={submit}>
			<div class="space-y-4">
				<div>
			...
			<button class="btn mt-8" type="submit">{isLoading ? '...loading' : 'Login'}</button>

			<p class="mt-8 text-center text-sm">
				Don't have an account? <a href="/register" class="underline underline-offset-2">Register</a>
			</p>
		</form>
	</Card>
</main>
